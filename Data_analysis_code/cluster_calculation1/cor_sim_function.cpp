...
//I wrote the final part in R, because after comparing the C++ and R versions of cor.sim, they were unsurprisingly the same (since there is no forlopp involved in cor.sim (see R file)).
