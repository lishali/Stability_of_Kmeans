...
#include <Rcpp.h> //this is C++ code for including certain standards...

// The line [[Rcpp::export]] before a function tells R to treat it like
// a native function.
// [[Rcpp::export]]
// the first two variables of our new DistanceCPP function is a Numberic Vector x and y, they are 
// R types, hence Rcpp:: preface in front.  
